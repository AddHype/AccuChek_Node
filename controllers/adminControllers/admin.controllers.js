...
// new course model with games
const addCources = async (req, res) => {
  try {
    const { name, id, description, points, status, duration, url, questions,kill_course,accu_men ,marquee_test,spinWheel_test } = req.body;
    ...
    const newCourse = new Course({
      ...
      accu_men: JSON.parse(req.body.accu_men),
      marquee_test: JSON.parse(req.body.marquee_test),
      spinWheel_test:JSON.parse(req.body.spinWheel)
    });
...
module.exports = {getSingleCourseGame,getProducts,dellProduct,addProduct,addCources,dellCource,getCources,getSingleProduct,updateSingleProduct,updateCource,adminSigin,adminRegister,getSingleCourse}